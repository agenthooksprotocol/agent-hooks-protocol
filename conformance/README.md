...
`manifest.json` maps language-neutral profile descriptions to stable requirement IDs. The profiles define externally observable inputs, outputs, and invariants without prescribing an implementation language, library, process model, or test framework.
