...
> This tracked migration preserves the complete substantive content of the source proposal as fetched on 2026-08-26. Notion-only metadata, discussion identifiers, user identifiers, and private source links were omitted. The canonical normative Working Draft is [`../spec/draft/index.md`](../spec/draft/index.md). Differences must be proposed publicly; this document does not silently resolve the open questions in Section 23.
