...
AHP v0.1 defines these Server Features:
...
Shared message, event, capability, transport, and other protocol mechanics are defined by the [Basic protocol](../basic/index.md).
